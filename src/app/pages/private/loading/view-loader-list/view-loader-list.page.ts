...
@Component({
  selector: 'app-view-loader-list',
  templateUrl: './view-loader-list.page.html',
  styleUrls: ['./view-loader-list.page.scss'],
})
export class ViewLoaderListPage  implements OnInit {
  ...
  loadusers() {
    ...
    if (this.searchText !== "") {
      ...
      this.userService.listbyRole(KeywordConstants.ROLE_LOADER,true,this.skip, this.limit, async (results:any) => {
        this.handleResponse(results);
        this.loaderService.dismissLoader();
      }, () => {
