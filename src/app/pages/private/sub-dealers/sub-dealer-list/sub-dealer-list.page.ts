...
@Component({
  ...
  templateUrl: './sub-dealer-list.page.html',
  styleUrls: ['./sub-dealer-list.page.scss'],
})
export class SubDealerListPage implements OnInit  {
  ...
  loadusers() {
    ...
    if (this.searchText !== "") {
      ...
      this.userService.listbyRole(KeywordConstants.ROLE_SUB_DEALDER,true,this.skip, this.limit, async (results:any) => {
        this.handleResponse(results);
        this.loaderService.dismissLoader();
      }, () => {
  ...
  userSelected(selectedUser:User) {
    ...
    this.router.navigate(["home/view-sub-dealer"], navigationExtras);
  }
  ...
  EditButtonClicked(selectedUser:User) {
    ...
    this.router.navigate(['home/update-sub-dealer'], navigationExtras);
  }
  //Click Events
  AddUserButtonClicked() {
    ...
    this.router.navigate(["home/create-sub-dealer"], navigationExtras);
  }
